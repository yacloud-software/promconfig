...
require (
	golang.conradwood.net/apis/common v1.1.4058
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.4058 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.4058 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.4058 // indirect
