...
require (
	golang.conradwood.net/apis/common v1.1.2709
	golang.conradwood.net/apis/htmlserver v1.1.2643
...
require (
	...
	golang.conradwood.net/apis/auth v1.1.2709 // indirect
	...
	golang.conradwood.net/apis/goeasyops v1.1.2709 // indirect
	...
	golang.yacloud.eu/apis/session v1.1.2709 // indirect
